...
class NotesMenu(menus.Menu):
    ...
    async def send_initial_message(self, ctx, channel):
        ...
        embed.add_field(name="1. Info", value="Get Info about Categories", inline=False)
        embed.add_field(name="2. Chords", value="Select Chords", inline=False)
    ...
    async def send_menu(self, ctx, page):
        if page == 0:
            ...
            for key, value in options[category].items():
                options_embed.add_field(name=key, value=value, inline=False)
